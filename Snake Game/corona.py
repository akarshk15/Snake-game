...
manimg = pygame.image.load("man1.png")  # load image
backgroundleft = pygame.image.load("left.png")  # load background left side image
backgroundright = pygame.image.load("right1.png")  # load background right side image
man_width = 23
...
def covid(corona_startx, corona_starty, police):  # define function
    if police == 0:  # at 0 stage
        corona_come = pygame.image.load("corona1.png")  
    if police == 1:  # at 1 stage
        corona_come = pygame.image.load("corona2.jpg")  
    if police == 2:
        corona_come = pygame.image.load("man1.png")  # police man1 come
